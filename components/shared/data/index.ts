...
export const sciFiCharacters = [
  ...
  "a mutant",
  "a space colonist",
  "a bio-engineered creature",
  "a rogue AI",
  "a virtual reality gamer",
  "a nanotechnologist",
  "a quantum physicist",
  "a space diplomat",
  "a technomancer",
  "a mech pilot",
  "a stowaway on a spaceship",
  "a space miner",
  "a robot assistant",
  "a galactic trader",
  "a space smuggler",
  "a cybernetic mercenary",
  "an android detective",
  "a space station commander",
  "a clone",
  "a teleportation expert",
  "a deep-space explorer",
  "a futuristic medic",
  "a virtual avatar",
  "a wormhole navigator",
  "an interstellar ambassador",
  "a sentient spaceship",
  "a terraformer",
  "a cryogenically frozen traveler",
];
