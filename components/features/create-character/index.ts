...
export async function getRandomCharacter() {
  ...
  if (randomGenre.name === Genre.FANTASY) {
    randomType =
      fantasyCharacters[Math.floor(Math.random() * fantasyCharacters.length)];
  ...
  if (randomGenre.name === Genre.SCIFI) {
    randomType =
      sciFiCharacters[Math.floor(Math.random() * sciFiCharacters.length)];
  ...
  if (randomGenre.name === Genre.DYSTOPIAN) {
    randomType =
      dystopianCharacters[
        Math.floor(Math.random() * dystopianCharacters.length)
      ];
    randomItem =
      dystopianItems[Math.floor(Math.random() * dystopianItems.length)];
    randomPlot =
      dystopianPlots[Math.floor(Math.random() * dystopianPlots.length)];
  }
