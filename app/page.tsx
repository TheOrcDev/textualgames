...
export default function Homepage() {
  return (
    <main className="relative flex h-svh w-full flex-col overflow-hidden rounded-md bg-black/[0.96] antialiased bg-grid-white/[0.02] md:items-center md:justify-center">
      <Spotlight />
